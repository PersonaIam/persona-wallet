...
const modules = [
  ...
  'monospaced.qrcode',
  'infinite-scroll',
  'personaclient.filters',
  'personaclient.services',
  'personaclient.components',
  'personaclient.directives',
  'personaclient.accounts',
  'personaclient.constants'
]

const app = angular.module('personaclient', modules)
